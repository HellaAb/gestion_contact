                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('prénom') is-invalid @enderror"
                               ...
                               value="{{ $contact->nom }}" aria-describedby="inputGroupPrepend" required>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('nom') is-invalid @enderror"
                               id="nom" name="nom"
                               value="{{ $contact->prenom }}" aria-describedby="inputGroupPrepend" required>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                               id="email" name="email"
                               value="{{ $contact->e_mail }}" aria-describedby="inputGroupPrepend" required>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('entreprise') is-invalid @enderror"
                               ...
                               value="{{  $contact->organisation->nom }}" required>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('code_postal') is-invalid @enderror"
                               ...
                               value="{{ $contact->organisation->code_postal }}" required>
                    </div>
                </div>
                <div class="col-md-10">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('ville') is-invalid @enderror"
                               id="ville" name="ville"
                               value="{{  $contact->organisation->ville }}"  required>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('entreprise') is-invalid @enderror"
                               ...
                               value="{{  $contact->organisation->statut }}" required>
                    </div>
