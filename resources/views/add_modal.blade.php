                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('prénom') is-invalid @enderror"
                               ...
                               value="{{ old('prénom') }}" aria-describedby="inputGroupPrepend" required>
                        @error('prénom')
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group has-validation">
                        <input type="text" class="form-control @error('nom') is-invalid @enderror"
                               id="nom" name="nom"
                               value="{{ old('nom') }}" aria-describedby="inputGroupPrepend" required>
                        @error('nom')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
...
<br>
    ...
    <div class="bottom-rectangle d-flex justify-content-end">
                    <div class="col-12">
                        <button class="btn btn-primary" type="submit">Ajouter</button>
                        <a href="/contacts-and-organisations/search" class="btn btn-danger">Annuler</a>
                    </div>
                </div>
</body>
</html>
